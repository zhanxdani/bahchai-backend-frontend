# Generated by Django 3.2.9 on 2022-02-18 14:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[('Новый', 1), ('Подтвержден', 2), ('Отправлен', 3), ('Доставлен', 4), ('Архивирован', 5)], db_index=True, default=1, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='menu.product', verbose_name='Товар')),
            ],
        ),
    ]
